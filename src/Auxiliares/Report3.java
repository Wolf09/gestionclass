...
public class Report3 extends javax.swing.JDialog {
    ...
    private String ruta;
    public Report3(java.awt.Frame parent, boolean modal,Connection c,String ruta) {      
        super(parent, modal);
        initComponents();
        this.c=c;
        this.ruta=ruta;
    ...
    private void initComponents() {
        ...
        nomi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "POA", "PEI", "ACREDITACIÓN", "IDH" }));
    ...
    public void rutaAPDF(String archivo){
        try {
           JasperReport reporte = (JasperReport) JRLoader.loadObject(new File(ruta));
             ...
             parametro.put("nom", nomi.getSelectedItem().toString());
