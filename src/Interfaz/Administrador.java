...
public class Administrador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("BIENVENIDO(A) ADMINISTRADOR(A):");
        ...
        menu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CONTROL DE ASISTENCIA", "DOCENTES", "PERSONAL ADMINISTRATIVO" }));
    ...
    private void btnIngActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngActionPerformed
        if((menu.getSelectedItem().toString()).equals("")){
            ...
            if((menu.getSelectedItem().toString()).equals("DOCENTES")){
                ...
                Posgrado.Materia in=new Posgrado.Materia();
                in.mostrardatos();
                in.setVisible(true);
            }if((menu.getSelectedItem().toString()).equals("PERSONAL ADMINISTRATIVO")){
                this.setVisible(false);
               Administrativos.Administrativo ad=new Administrativos.Administrativo();
               ad.mostrardatos();
               ad.setVisible(true);
            }if((menu.getSelectedItem().toString()).equals("CONTROL DE ASISTENCIA")){
                    this.setVisible(false);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        Usuarios mo=new Usuarios(new java.awt.Frame(), true);
        mo.mostrardatos();
        mo.setVisible(true);   
