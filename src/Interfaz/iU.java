 ...
 * @author WjhonB
 */
public class iU extends javax.swing.JDialog {

    private Bien icono2;
    public iU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 3), "NUEVO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void botAgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botAgActionPerformed
        ...
        if(usu.getText().equals("")||contra.getText().equals("")||(tipo.getSelectedItem().toString()).equals("")){
            ...
            try {
                PreparedStatement pst = cn.prepareStatement("INSERT INTO usuarios(usuario,contrasena,tipo) VALUES (?,?,?)");
                ...
                new MensajeBeep().showMessageDialog(this, "Operación Incorrecta, Usuarios DUPLICADOS"+sep+"O la cantidad de letras sobrepasa lo permitido para un campo NO SE REALIZO CAMBIOS!!!","",JOptionPane.WARNING_MESSAGE,null);
