 ...
 * @author WjhonB
 */
public class ChatEst1 extends javax.swing.JDialog {

    private MCliente2 cliente=null;
    private DefaultListModel dlm=new DefaultListModel();
    private Bien icono2;
    private Advertencia icono;
    private static String miip;
    public ChatEst1(java.awt.Frame parent, boolean modal,String miip1) {
        super(parent, modal);
        initComponents();
    ...
    private void botCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botCActionPerformed
        lista.setModel(dlm);
        if(nick.getText().contains("DOCENTE")||nick.getText().contains("Docente")||nick.getText().contains("docente")){
            new MensajeBeep().showMessageDialog(this, "El nick de usuario no puede contener: DOCENTE","ERROR",JOptionPane.WARNING_MESSAGE,null);
            ...
            try{
                ...
                if (cliente==null){
                    cliente = new MCliente2(port,url,nick,this);
                    cliente.start();
                }
