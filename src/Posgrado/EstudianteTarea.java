...
public class EstudianteTarea extends javax.swing.JDialog {
    ...
    public EstudianteTarea(java.awt.Frame parent, boolean modal,String tarea6,String coddoc6,String ges6,String mat6,String men6) {
        super(parent, modal);
        initComponents();
        tarea5=tarea6;
        coddoc5=coddoc6;
    ...
    Object []datos = new String [8];
        try {
            ...
            Logger.getLogger(EstudianteTarea.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        tabE.setComponentPopupMenu(capturar);
    ...
    private void descargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_descargarActionPerformed
        ...
        if(fila>= 0){
                ...
                if(comprobar(tabE.getValueAt(fila, 3).toString(),tabE.getValueAt(fila, 1).toString(),coddoc5,tabE.getValueAt(fila, 0).toString(),tabE.getValueAt(fila, 4).toString(),tabE.getValueAt(fila, 5).toString())==true){
                        aux1=pedirArc(tabE.getValueAt(fila, 3).toString(),tabE.getValueAt(fila, 1).toString(),coddoc5,tabE.getValueAt(fila, 0).toString(),tabE.getValueAt(fila, 4).toString(),tabE.getValueAt(fila, 5).toString());
                         ProgresoDes pro=new ProgresoDes(new java.awt.Frame(), true,aux1, tabE.getValueAt(fila, 1).toString());
                         pro.setVisible(true);
                }
